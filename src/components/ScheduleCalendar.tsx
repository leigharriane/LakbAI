...
export default function ScheduleCalendar({
	...
	return (
		<>
			<div className="overflow-auto w-full flex flex-col mb-2 text-white" id="schedule">
			...
			{isDeleteOpen && (
				<div
					className="fixed text-[12px] px-6 py-2 shadow rounded z-10 bg-dark cursor-pointer"
