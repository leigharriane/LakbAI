...
import getCalendar from '@/app/util/getCalendar'
import addWeek from '@/app/util/addWeek';
import addMonth from '@/app/util/addMonth'
...
export const calendarSlice = createSlice({
  ...
  initialState,
  reducers: {
    nextWeek: (state: { current: { day: any }; select: any }) => {
    ...
    nextMonth: (state: { current: { day: any }; select: any }) => {
    ...
    lastWeek: (state: { current: { day: any }; select: any }) => {
    ...
    lastMonth: (state: { current: { day: any }; select: any }) => {
    ...
    selectDay: (state: { select: any; current: any }, action: PayloadAction<string>) => {
